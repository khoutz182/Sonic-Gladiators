...
public class Prototype {
    ...
    public static void main(String[] args) {
        ...
        short strengthPrev = (short) Math.abs((short) finalByteArray[0]);
        //long strength = strengthPrev & 0xffffffffl;
        short vitalityPrev = (short) Math.abs((short) finalByteArray[1]);
        //long vitality = vitalityPrev & 0xffffffffl;
        short dexterityPrev = (short) Math.abs((short) finalByteArray[2]);
